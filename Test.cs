...
namespace DungeonCrawler
{
    internal class Test
    {
        ...
        public void RunForRoom() 
        {
            ...
            System.Diagnostics.Debug.Assert(_room.ItemList.Count >= 3, "Items in the room must number at least three if there is any chance of combat occurring else an ArgumentNullException will occur for the 6th element of jinxedMisses.");
           ...
           // System.Diagnostics.Debug.Assert(_room.ItemList.Count(x => x.GetType() == typeof(Weapon)) > 0, "When Instantiated, a room must have at least one weapon");
        }
